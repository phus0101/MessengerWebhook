...
public class QuickReplySalesStateHandler : SalesStateHandlerBase
{
    public override ConversationState HandledState => ConversationState.QuickReplySales;

    public QuickReplySalesStateHandler(
